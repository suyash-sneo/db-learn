...
const PHASES = [
  ...
  { id: "p2", num: "2", title: "The single file & the pager", dir: "phases/02-pager",
    lessons: [
      ["2.1","Why fixed-size pages","01-pages.html","done"],
      ["2.2","The file header","02-file-header.html","done"],
      ["2.3","Page numbers ↔ offsets","03-page-offsets.html","done"],
      ["2.4","Reading/writing pages; the VFS","04-vfs.html","done"],
      ["2.5","The page cache / buffer pool","05-buffer-pool.html","done"],
      ["2.6","Flushing, fsync, the durability gap","06-fsync.html","done"],
      ["2.7","Source dive: SQLite pager.c","07-source-pager.html","done"],
      ["build","Build: a Rust pager","build.html","done"],
    ] },
  { id: "p3", num: "3", title: "The index: B+tree", dir: "phases/03-btree",
    lessons: [
      ["3.1","Why an ordered, disk-oriented index","01-why-btree.html","done"],
      ["3.2","B-tree vs B+tree; internal vs leaf","02-bplus.html","done"],
      ["3.3","Node layout inside a page","03-node-layout.html","done"],
      ["3.4","Search / traversal","04-search.html","done"],
      ["3.5","Insert & node splits","05-insert-split.html","done"],
      ["3.6","Delete, merge, rebalance","06-delete.html","done"],
      ["3.7","B-tree vs LSM revisited","07-lsm.html","done"],
      ["3.8","Source dive: SQLite btree.c","08-source-btree.html","done"],
      ["3.9","Source dive: LMDB/MDBX copy-on-write","09-source-lmdb.html","done"],
      ["build","Build: a persistent B+tree","build.html","done"],
    ] },
  { id: "p4", num: "4", title: "Records & free space", dir: "phases/04-records-freespace",
    lessons: [
      ["4.1","Fixed vs variable-length records","01-records.html","done"],
      ["4.2","Slotted pages","02-slotted-pages.html","done"],
      ["4.3","Cell formats & overflow pages","03-overflow.html","done"],
      ["4.4","Deleting; fragmentation & compaction","04-compaction.html","done"],
      ["4.5","The freelist","05-freelist.html","done"],
      ["4.6","Source dive: SQLite record/cell + freelist","06-source-records.html","done"],
      ["build","Build: slotted pages + freelist","build.html","done"],
    ] },
  { id: "p5", num: "5", title: "Durability: journal, WAL, recovery", dir: "phases/05-durability-wal",
    lessons: [
      ["5.1","ACID at the storage layer","01-acid.html","done"],
      ["5.2","The crash model","02-crash-model.html","done"],
      ["5.3","Rollback journal","03-rollback-journal.html","done"],
      ["5.4","Write-ahead logging","04-wal.html","done"],
      ["5.5","Checkpointing","05-checkpoint.html","done"],
      ["5.6","Recovery on open","06-recovery.html","done"],
      ["5.7","Transactions at the engine level","07-transactions.html","done"],
      ["5.8","Source dive: SQLite wal.c","08-source-wal.html","done"],
      ["build","Build: WAL + recovery + crash test","build.html","done"],
    ] },
  { id: "p6", num: "6", title: "The document layer", dir: "phases/06-document-layer",
    lessons: [
      ["6.1","From records to documents","01-documents.html","done"],
      ["6.2","BSON vs MessagePack vs JSON","02-serialization.html","done"],
      ["6.3","Storing documents","03-storing.html","done"],
      ["6.4","CRUD on the engine","04-crud.html","done"],
      ["6.5","Secondary indexes on fields","05-secondary-indexes.html","done"],
      ["6.6","The query model & evaluator","06-query-model.html","done"],
